...
import 'package:annotation_route_demo/first_page.dart';
import 'package:annotation_route_demo/second_page.dart';
...
class ARouterInternalImpl extends ARouterInternal {
  ...
  dynamic instanceFromClazz(Type clazz, dynamic option) {
    switch (clazz) {
      case FirstPage:
        return new FirstPage(option);
      case SecondPage:
        return new SecondPage(option);
      default:
        return null;
    }
  }
